...
1 - pyinstaller --onedir --noconsole --runtime-tmpdir "%LOCALAPPDATA%\ConversioTemp" conversioCSV.py  --> Crea amb carpeta dist

2 - pyinstaller --onefile --noconsole --runtime-tmpdir "%LOCALAPPDATA%\ConversioTemp" conversioCSV.py--> Crea nomes un executble 
